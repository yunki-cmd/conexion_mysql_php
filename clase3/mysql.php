<?php
    ...
    */
    ...
    class Mysql{
            ...
            public $strInsert='insert into resumen_productos(nombre,categoria,precio,cantidad_vendidos,en_almacen,fecha_alta) values("producto-1","categoria-2","199.00","30","100","2019-01-01")';
